...
6. `v-calendar` caches the attributes for each day until it needs to refetch. On day events (`dayclick`, `daymouseenter`, `daymouseleave`) the days attributes are sent in the [`day`](api.md#day-object) event object.